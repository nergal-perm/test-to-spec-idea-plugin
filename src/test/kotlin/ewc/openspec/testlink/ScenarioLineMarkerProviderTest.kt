...
class ScenarioLineMarkerProviderTest : BasePlatformTestCase() {
    ...
    @Scenario(capability = "test-to-spec-gutter-link", value = "Single annotation on a Kotlin function")
    ...
    @Scenario(capability = "test-to-spec-gutter-link", value = "Multiple annotations on a Kotlin function")
    ...
    @Scenario(capability = "test-to-spec-gutter-link", value = "Annotation on a Kotlin class produces no gutter icon")
    ...
    @Scenario(capability = "test-to-spec-gutter-link", value = "Tooltip on annotation-row icon")

...
This capability adds gutter icons to Markdown spec files, linking scenario headings back to their referencing test methods. Icons reflect test coverage at a glance and allow navigation to tests directly from the spec.
